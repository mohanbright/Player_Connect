...
class _ConnectWithPageState extends State<ConnectWithPage> {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<ConnectWithProvider>(
      create: (_) {
        return ConnectWithProvider();
      },
      child: Consumer<ConnectWithProvider>(
                              ...
                              itemBuilder: (context, index) {
                                return Padding(
                                  padding: EdgeInsets.fromLTRB(0,
                                      AppFontSize.font4, 0, AppFontSize.font4),
                                  child: Container(
